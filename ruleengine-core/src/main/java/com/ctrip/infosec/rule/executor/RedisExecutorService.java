 ...
 */
public class RedisExecutorService
{
    private static Logger logger = LoggerFactory.getLogger(RedisExecutorService.class);
    ...
    /*
    从Redis获取数据并且合并到当前的fact中
    获取的是多个eventPoint对应的合并的key
     */
