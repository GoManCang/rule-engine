...
public class ESBClient {
    ...
    private static String requestWithSoap(String soapRequestContent) {
        ...
        try {
            Response response = Request.Post(esbConfig.getESBUrl()).body(new StringEntity(soapRequestSOAPData.toString())).
            ...
            logger.error(Contexts.getLogPrefix() + "invoke esb fault.", ex);
        }
        return null;
    }
